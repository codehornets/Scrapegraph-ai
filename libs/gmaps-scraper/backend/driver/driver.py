...
class DriverBase:
    ...
    def switch_to_tab(self, tab: Tab) -> Tab:
        self._tab = tab
    ...
    def run_on_new_document(self, script) -> None:
        self.run_cdp_command(cdp.page.enable())
        return self.run_cdp_command(
    ...
    def click_at_point(self, x: int, y: int):
        self._run(self._tab.click_at_point(x, y))
    ...
    def count(self, selector: str, wait: Optional[int] = Wait.SHORT) -> List[Element]:
