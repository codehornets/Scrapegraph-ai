...
from backend.core.decorators_common import (
    print_running,
    evaluate_proxy,
    write_output,
    IS_PRODUCTION,
...
def request(
    ...
    *,
    ...
    def decorator_requests(func: Callable) -> Callable:
        ...
        if use_stealth:
            print(
                "The use_stealth option has been deprecated and will be removed in future releases. Botasaurus now includes best stealth protection enabled by default. To avoid this warning, please remove use_stealth=True from your code."
            )
