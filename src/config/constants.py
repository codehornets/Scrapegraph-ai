...
MARKETING_GOALS_FILE_PATH = os.getenv(
    "MARKETING_GOALS_FILE_PATH", "marketing_goals.json"
)
...
OPENCORPORATES_API_KEYS = os.getenv("OPENCORPORATES_API_KEYS")
GRAPH_CONFIG = {
    # "llm": {
